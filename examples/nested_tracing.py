...
@task("move_to_position", tags=["navigation"])
...
def complex_manipulation(robot):
    ...
    # Sub-task 3: Finish
    with task_context("shutdown_sequence"):
        robot.Damp()
        robot.StandDown()
